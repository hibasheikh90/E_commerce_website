        ...
        <div className="py-2 mx-auto">
          ...
          <div>
            ...
            <p className="flex justify-between ">
              Dress <span className="font-bold">$236.00</span>
            </p>
          </div>
        </div>
        <div>
          ...
          <p className="flex justify-between ">
            bag <span className="font-bold">$130.00</span>
          </p>
        </div>
        <div>
          ...
          <p className="flex justify-between ">
            Dress <span className="font-bold">$364.00</span>
          </p>
        </div>
        <div>
          ...
          <p className="font-bold my-3">Nike Sportswear Futura Luxe</p>
          <p className="flex justify-between ">
            Dress <span className="font-bold">$220.00</span>
          </p>
        </div>
      </div>
    </div>
